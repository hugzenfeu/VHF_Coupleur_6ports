...
for i in range(len(data)):
    for j in range(len(data[0])-1):#issue constant input bigger dataset needed
...
model.save_weights(f"models\\my_model_weights_var_cor_lower_dim{date_time.replace(':','_').replace('/','_')}.h5")
