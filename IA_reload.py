...
model_name="models\\my_model_weights_var_cor05_04_2019-18_03_55.h5"

model.load_weights(model_name)


opt = tf.keras.optimizers.Adam(lr=0.0000005, beta_1=0.9, beta_2=0.999, epsilon=None, decay=0, amsgrad=False)
...
for i in range(64):
    ...
    np.save("finloss.npy",print_loss)
